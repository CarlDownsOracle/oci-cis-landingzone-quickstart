...
locals {
  ...
  appdev_compartment            = {key:"${var.service_label}${var.appdev_label}${var.compartment_label}",       name:"${var.service_label}${var.appdev_label}${var.compartment_label}"}
  exainfra_compartment          = {key:"${var.service_label}${var.exadata_label}${var.compartment_label}",      name:"${var.service_label}${var.exadata_label}${var.compartment_label}"}
